...
#define BOTtoken "8776276174:AAG3lgneM0cywkp57c03FtEJFd5zqi4JIKk"
#define GROUP_ID "8652307048" 
...
void handleNewMessages(int numNewMessages) {
  ...
  for (int i = 0; i < numNewMessages; i++) {
    ...
    if (text == "/led_on") {
      ...
      bot.sendMessage(chat_id, "✅  LED da BAT sang!", "");
    } 
...
void setup() {
  ...
  bot.sendMessage(GROUP_ID, "🚀 He thong cua Nhan da Online!", "");
}
