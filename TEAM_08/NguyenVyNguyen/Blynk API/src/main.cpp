...
#define BLYNK_TEMPLATE_ID "TMPL60XaeGCWD"
#define BLYNK_TEMPLATE_NAME "Blynk API"
#define BLYNK_AUTH_TOKEN "NanbugQOIaUU5bwFyn6F05ejlv7T4IcP"
...
#define OPENWEATHERMAP_KEY "YOUR_API_KEY" // Thay KEY của bạn vào đây
