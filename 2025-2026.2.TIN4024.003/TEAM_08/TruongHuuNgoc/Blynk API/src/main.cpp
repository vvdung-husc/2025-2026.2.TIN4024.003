...
#define BLYNK_TEMPLATE_ID "TMPL6pO8nFxC2"
#define BLYNK_TEMPLATE_NAME "ESP 32 API"
#define BLYNK_AUTH_TOKEN "hJYYkZ1ho1XChVKJTlgglVK1tBeI3isB"
...
#define OPENWEATHERMAP_KEY "xxx" // Thay KEY của bạn vào đây
